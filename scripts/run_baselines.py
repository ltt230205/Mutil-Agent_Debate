    ...
    with out_path.open("w", encoding="utf-8") as handle:
        for seed in cfg.random_seeds:
            ...
            for sample in samples:
                records = [
                    run_single(sample, client, cfg.prompts_dir, "single_direct", seed),
                    run_single(sample, client, cfg.prompts_dir, "single_cot", seed),
                    run_self_consistency(sample, client, cfg.prompts_dir, cfg.self_consistency_k, seed),
                    run_multi_agent_majority(sample, client, cfg.prompts_dir, cfg.default_agents, seed),
                ]
